...
<template>
  <ToastAction 
    ...
    :class="cn(
      ...
      {
        'group-[.destructive]:border-muted/40 group-[.destructive]:hover:border-destructive/30 group-[.destructive]:hover:bg-destructive group-[.destructive]:hover:text-destructive-foreground group-[.destructive]:focus:ring-destructive': props.variant === 'destructive',
        'group-[.success]:border-green-500 group-[.success]:hover:bg-green-600 group-[.success]:hover:text-white group-[.success]:focus:ring-green-500': props.variant === 'success', 
      },
      props.class
    )"
  >
